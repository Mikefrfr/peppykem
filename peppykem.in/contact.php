          ...
          <div class="col-md-3">
            <div class="widget no-border m-0">
              <ul class="list-inline font-13 sm-text-center mt-5">
                ...
                <li>
                  <a class="text-white" href="#"> peppykem@peppykem.in</a>
                </li>
              </ul>
            </div>
          </div>
			<div class="col-md-6">
				<marquee><p class="text-white text-center"> Lockdown special Online classes for 2 to 4 year,Keyboard,Karate,Yoga,Chess and Music Classes by experts. 
Call us today to register.</p></marquee>
			</div>
         <!-- <div class="col-md-4">
            <div class="widget no-border m-0">
              <ul class="list-inline font-13 sm-text-center mt-5">
          ...
          <div class="col-xs-12 col-sm-4 col-md-6" style="margin-top:20px;">
            <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
              <ul class="list-inline">
                ...
                <li>
                  <a href="#" class="font-12 text-black text-uppercase">We are temporarily closed due to Covid-19 ! But Online Classes Open</a>
        ...
        <div class="container">
          <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
           <ul class="menuzord-menu">
              ...
              <li class=""><a href="#">Program</a>
                <ul class="dropdown">
                  <li><a href="online.php">Online/ Remote classes</a></li>
			  ...
			  <li class=""><a href="facility.php">Our Facilities</a></li>
            ...
            <ul class="pull-right flip hidden-sm hidden-xs">
              <li>
                ...
                <a class="btn btn-colored btn-flat bg-theme-color-sky text-white font-14 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" data-toggle="modal" data-target="#BSParentModal" href="contact.php">Book Now</a>
                <!-- Modal: Book Now End -->
              </li>
            </ul>
        ...
        <div class="row pt-10">
          <div class="col-md-5">
            <h4 class="mt-0 mb-30 line-bottom">Find Our Location</h4>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.6575375622992!2d80.26483631430457!3d12.993742217909018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267f9b54d4e67%3A0x665ea9019acd3b8f!2sPeppy%20Kem!5e0!3m2!1sen!2sin!4v1591267770075!5m2!1sen!2sin" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>          </div>
          <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group mb-20">
                      <input placeholder="Enter Name" type="text" name="name" required="" class="form-control">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                    ...
                    <div class="form-group mb-20">
                      <div class="styled-select">
                        <select name="course" class="form-control" required="">
                          ...
                          <option value="Children Club Activities">Children Club Activities</option>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input name="dob" class="form-control required date-picker" type="text" placeholder="Date Of Birth" aria-required="true">
                    </div>
                  </div>
                  <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group mb-0 mt-10">
                      ...
                      <button type="submit" class="btn btn-colored btn-theme-color-sky text-white btn-lg btn-block" name="submit" data-loading-text="Please wait...">Submit Request</button>
                    </div>
                  </div>
                </div>
              </form>
        ...
        <div class="row mt-60">
          <div class="col-sm-12 col-md-4">
            <div class="contact-info text-center bg-theme-color-sky border-1px pt-60 pb-60">
              ...
              <h6 class="text-white">Phone: 9840003355</br> 044-42033280</h6>
            </div>
          </div>
          <div class="col-sm-12 col-md-4">
            <div class="contact-info text-center bg-theme-color-green border-1px pt-60 pb-60">
              ...
              <h4>Address</h4>
              <h6 class="text-white">No. 44, MGR Road, Kalakshethra Colony,
Besant Nagar, Chennai- 600090.</h6>
            </div>
          </div>
          <div class="col-sm-12 col-md-4">
            <div class="contact-info text-center bg-theme-color-sky border-1px pt-60 pb-60">
              ...
              <h6 class="text-white">peppykem@peppykem.in</br></br></h6>
            </div>
          </div>
...
Besant Nagar, Chennai- 600090.</p>
            <ul class="list-inline mt-5">
              ...
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-color-lemon mr-5"></i> <a class="text-gray" href="#">peppykem@peppykem.in</a> </li>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list angle-double-right list-border">
              ...
              <li><a href="preschool.php">Our Courses</a></li>
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-white m-0">Copyright &copy;2021 PeppyKem. All Rights Reserved</p>
          </div>
